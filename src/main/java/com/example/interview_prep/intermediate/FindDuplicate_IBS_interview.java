...
public class FindDuplicate_IBS_interview {
    public static void main(String[] args) {
        ...
        List<Integer> collect =
                ...
                // Convert the primitive int to wrapper Integer. IntStream of primitives is converted into Stream<Integer> of wrapper objects. This is necessary because the subsequent steps, which involve Collectors methods, work with objects, not primitives. The stream is still [1, 2, 3, 3, 4, 5, 4, 5, 6], but the elements are now Integer objects.
                .boxed()
